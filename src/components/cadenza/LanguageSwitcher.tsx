...
const NavLinkContent = ({ link, tNav, tHome, isSheet = false }: { link: NavLink, tNav: any, tHome: any, isSheet?: boolean }) => {
    ...
    const badge = link.badge && (
        <Badge
            size="icon"
            className={cn(
                "absolute -bottom-1 -right-4 bg-transparent border-none",
                 isSheet && "-bottom-0 -right-4"
            )}
        >
            {badgeContent}
        </Badge>
