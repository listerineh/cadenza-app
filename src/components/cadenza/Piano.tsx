              ...
              <span
                className={cn(
                  ...
                  !(isSelected || isHighlighted) &&
                    (isInteractive ? 'opacity-0 group-hover:opacity-50 transition-opacity' : 'opacity-0'),
                )}
              >
                {noteInfo.note}
                {noteInfo.octave}
        ...
        {blackKeys.map((noteIndex) => {
          ...
          if (isSelected) {
            keyColor = isRoot
              ...
              : 'bg-primary border-2 border-primary/50 text-primary-foreground';
          } else if (isHighlighted) {
            keyColor = isRoot
              ? 'bg-primary border-2 border-primary-foreground text-primary-foreground'
              : 'bg-accent border-2 border-accent/50 text-accent-foreground';
          }
