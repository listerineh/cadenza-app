    ...
    >
      ...
      {CIRCLE_OF_FIFTHS_MAJOR.map((key, index) => {
        ...
        const isLineActive =
          isSelected(key) ||
          isHovered(key) ||
          isHovered(CIRCLE_OF_FIFTHS_MINOR[index]);
        return (
          <line
            key={`line-${key}`}
            x1={majorCoords.x}
        ...
        return (
          ...
          >
            <circle
              ...
              stroke={
                isKeySelected ? "hsl(var(--primary))" : "hsl(var(--border))"
              }
        ...
        return (
          ...
          >
            <circle
              ...
              r={20}
              fill={
                isKeySelected ? "hsl(var(--secondary))" : "hsl(var(--muted))"
              }
              stroke={
                isKeySelected ? "hsl(var(--secondary))" : "hsl(var(--border))"
              }
